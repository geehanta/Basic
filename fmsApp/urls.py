...
urlpatterns = [
    ...
    path('review-training-records/', views.training_record_list, name='review_training_records'), # lists all records
    path('review-form/<int:record_id>/', views.training_record_review, name='review_training_records'),#reviewer adds/view training records
